...
;              
; Memory use:     RAM Location from $3000 for data and stack
...
;                 SW1 NOT pressed: (1) LED 4 turn on for 1 second, then LED 1 turn on for 1 second, and repeat
;                 SW1 pressed: (2) Trun on each LED for 1 second, then repeat
;
;******************************************************************************************************
...
;
;Symbols and Macros
PORTA     EQU         $0000        ;read/Write port A addresses
DDRA      EQU         $0002        ;set input/output port A address
PORTB     EQU         $0001        ;read/Write port B addresses
DDRB      EQU         $0003        ;set input/output port B address
;
;******************************************************************************************************
